...
export const caseStudies = [
  ...
  },
  {
    ...
    company: "Projet personnel",
    logo: "/favicon.ico",
    role: "Développeur Frontend – Portfolio",
    year: "2025–2026",
    location: "France",
    category: "web",
    contractLabel: "Projet personnel",
    headline: "Portfolio interactif (Next.js) – Expérience premium & animations",
    summary:
      "Portfolio moderne et très visuel : navigation sticky, indicateur de section, micro-interactions, mise en avant des projets, et performances soignées.",
    link: null,
    contextBullets: [
      "Besoin : présenter clairement mon profil, mes compétences et mes réalisations.",
      "Objectif : une expérience utilisateur premium, simple et lisible (recruteur-friendly).",
    ],
    actionsBullets: [
      "Développement d’une landing immersive : hero, projets, compétences, contact.",
      "Mise en place d’animations et micro-interactions (Framer Motion) sans alourdir l’UX.",
      "Navigation sticky avec indicateur de section active + scroll progress bar.",
      "Design glassmorphism : cartes premium, gradients, contrastes, détails visuels.",
      "Optimisation UI : responsive, accessibilité (focus-visible), liens externes sécurisés.",
    ],
    impactBullets: [
      "Meilleure compréhension du profil en quelques secondes (structure + lisibilité).",
      "Vitrine technique crédible (Next.js, UI premium, animations maîtrisées).",
      "Base évolutive pour ajouter projets / retours / nouvelles sections.",
    ],
    techs: ["Next.js", "React", "Tailwind CSS", "Framer Motion", "UI/UX", "Responsive", "Accessibilité"],
    skillTags: ["next", "react", "frontend", "agile", "git"],
    prioRecruiter: true,
  },
  {
    key: "gite-servance",
