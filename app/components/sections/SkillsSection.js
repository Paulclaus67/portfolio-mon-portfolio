  ...
  return (
    <>
      ...
      <section className="py-14 md:py-16 border-y border-slate-200/70 bg-slate-900/3 -mx-4 sm:-mx-6 px-4 sm:px-6 dark:border-slate-800/50 dark:bg-black/20">
        ...
        <div className="flex items-center gap-6 overflow-x-auto pb-2 opacity-90 transition-all duration-500 scrollbar-none sm:justify-center md:flex-nowrap md:gap-8 md:overflow-visible md:pb-0 md:opacity-80 lg:gap-10">
          {trustedLogos.map((brand) => (
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="group inline-flex shrink-0 items-center justify-center transition-transform focus-visible:outline-none md:flex-1 md:basis-0 md:hover:scale-[1.03]"
              aria-label={`Ouvrir ${brand.name}`}
            >
              <div className="relative h-10 w-[132px] sm:h-11 sm:w-[145px] md:h-12 md:w-full md:max-w-[150px] lg:h-14 lg:max-w-[168px]">
                <Image
                  src={brand.src}
                  alt={brand.name}
                  fill
                  sizes="(min-width: 1024px) 168px, (min-width: 768px) 150px, (min-width: 640px) 145px, 132px"
